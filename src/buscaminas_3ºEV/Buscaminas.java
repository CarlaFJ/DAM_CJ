...
public class Buscaminas {
	...
	public int leerNumero(String mensaje) {
		...
		while (!numeroValido) {
			...
			try {
				...
				JOptionPane.showMessageDialog(null, "Debes introducir un número entero válido");
			}
		}
	...
	public void validarCoordenadas(int fila, int columna)
			throws CordenadaInvalidaException, CasillaYaReveladaException {

		if (fila < 0 || fila > 7 || columna < 0 || columna > 7) {

			throw new CordenadaInvalidaException();
		}

		if (!tableroJugador[fila][columna].equals("-")) {

			throw new CasillaYaReveladaException();
		}
	}
	...
	public boolean pedirCoordenadas() {
		...
		while (!coordenadaValida) {
			...
			try {
				...
				int fila = leerNumero("Introduce nº fila (0|1|2|3|4|5|6|7|):");

				int columna = leerNumero("Introduce nº columna (0|1|2|3|4|5|6|7|):");
			...
			} catch (CordenadaInvalidaException e) {

				JOptionPane.showMessageDialog(null, e.getMessage());

			} catch (CasillaYaReveladaException ex) {
