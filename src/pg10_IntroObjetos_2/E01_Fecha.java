...
import pg09_IntroObjetos.E10_Fecha;

public class E01_Fecha {
	private int dia;
	private int mes;
	private int anyo;
	...
	public E01_Fecha(int dia, int mes, int anyo) {
		this.dia = dia;
		this.mes = mes;
		this.anyo = anyo;
	}
	...
	public E01_Fecha(String textoFecha) {
	...
	public boolean equals(E01_Fecha fecha) {
	...
	public boolean isposterior(E01_Fecha f) {
		if (this.anyo > f.anyo)
			return true;
		if (this.anyo < f.anyo)
			return false;
	...
	public int CompareTo(E01_Fecha Fech) {
	...
	public int diasHastav1(E01_Fecha f) {
